...
namespace BH.Adapter.SQLite
{
    public partial class SQLiteAdapter
    {
        ...
        [Description("Gets the .NET type name associated with a table name from the __Types table.")]
        ...
        private string GetTypeName(SqliteConnection connection, string tableName)
        {
            ...
            {
                BH.Engine.Base.Compute.RecordError($"Failed to get type name for table '{tableName}': {ex.Message}");
                return null;
            }
        }
