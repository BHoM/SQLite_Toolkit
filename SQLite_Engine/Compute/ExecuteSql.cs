...
namespace BH.Engine.SQLite
{
    public static partial class Compute
    {
        ...
        [Description("Executes a SQL statement with optional parameters against a SQLite connection.")]
        [Input("connection", "The SQLite connection to execute the statement against.")]
        [Input("sql", "The SQL statement to execute.")]
        [Input("parameters", "Optional dictionary of parameter names and values for parameterised queries.")]
