...
namespace BH.Engine.SQLite
{
    public static partial class Query
    {
        ...
        public static object ExtractMappedValue(this IBHoMObject obj, MappingInfo mappingInfo)
        {
            ...
            try
            {
                ...
                {
                    return ExtractFragmentValue(obj, mappingInfo.FragmentType, mappingInfo.PropertyPath);
                }
                else
                {
        ...
        public static object ExtractMappedValue(this IBHoMObject obj, string propertyPath)
        {
